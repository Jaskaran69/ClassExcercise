...
console.log('The position of the word "JavaScript":', SENTENCE.search('JavaScript'))

console.log('The position of the last \'is\':', SENTENCE.lastIndexOf('is'))

console.log('The last sentence only:', SENTENCE.slice(SENTENCE.lastIndexOf('The'), SENTENCE.lastIndexOf('.') + 1))
